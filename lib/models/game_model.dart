  ...
  static List<Game> getFeaturedGames() {
    return [
      ...
      Game(
        ...
        coverImage:
            'https://api.builder.io/api/v1/image/assets/TEMP/a0aec7389b59c267fe9e6cb147a75e605ac97963?width=522',
        iconImage:
            'https://api.builder.io/api/v1/image/assets/TEMP/a0aec7389b59c267fe9e6cb147a75e605ac97963?width=152',
      ),
      Game(
        id: '3',
        name: 'Genshin Impact',
      ...
      Game(
        ...
        developer: 'SMILEGATE',
        coverImage:
            'https://api.builder.io/api/v1/image/assets/TEMP/b6b37adee9f4fbb668f63cc672bc905e39eaaab1?width=522',
        iconImage:
            'https://api.builder.io/api/v1/image/assets/TEMP/c55444771d6898bcda1c1186784d938880632453?width=152',
      ),
      Game(
        id: '6',
        name: 'Blue Archive',
  ...
  static List<Game> getSuggestedGames() {
    return [
      ...
      Game(
        ...
        developer: 'HOYOVERSE',
        coverImage:
            'https://api.builder.io/api/v1/image/assets/TEMP/dfff216821ed367a01cab4a1dbbde4ecb8a0fa1d?width=522',
        iconImage:
            'https://api.builder.io/api/v1/image/assets/TEMP/0414e9d4e3f0b996f7b4858412ddffd12c5e3a08?width=152',
      ),
      Game(
        id: '1',
        name: 'Arknights: Endfield',
  ...
  static List<Game> getPaidGames() {
    return [
      ...
      Game(
        ...
        developer: '',
        coverImage:
            'https://api.builder.io/api/v1/image/assets/TEMP/c6e852838e756294dc66013da3ac7f34a8d0e2be?width=330',
        price: '1.99\$',
      ),
      Game(
        id: '22',
        ...
        developer: '',
        coverImage:
            'https://api.builder.io/api/v1/image/assets/TEMP/a0aec7389b59c267fe9e6cb147a75e605ac97963?width=330',
        price: '5.99\$',
      ),
      Game(
        id: '23',
  ...
  static List<Game> getProductGames() {
    return [
      ...
      Game(
        ...
        coverImage:
            'https://api.builder.io/api/v1/image/assets/TEMP/692b20fc12e646dd1d7d11242c49a21102539cd0?width=522',
        iconImage:
            'https://api.builder.io/api/v1/image/assets/TEMP/c2b588ca2eb1afc771ca94fd1432671709896915?width=152',
      ),
      Game(
        id: '34',
